...
let images = [
  {
    ...
    likes: 4,
    name: "pintrest",
    url: "https://img.stackshare.io/stack/9/default_ce2cf17eee07d2fe12f8074a4c85b9f1220a92cd.png",
  },
  {
    date: 20210101,
    comments: 3,
    likes: 2,
    name: "uber",
    url: "https://img.stackshare.io/stack/5/default_e436fbdf25e5c8e89e2137cf2f1dd2cffa56d8e1.png",
  },
  {
    date: 20210104,
    comments: 2,
    likes: 1,
    name: "airbnb",
    url: "https://img.stackshare.io/stack/2/default_04dd469129d2bfe4f9fbe36583faac05993d6643.jpeg",
  },
  {
    date: 20210102,
    comments: 4,
    likes: 3,
    name: "instacart",
    url: "https://img.stackshare.io/stack/151/default_3ce09436992cc7acf205672544d986a3fc92f006.png",
  },
];
////////////////////////////////////
function filter() {
...
function createCookie(word) {
  ...
  document.cookie =
    ...
    console.log(    "sortType=" + word + "; expires=" + expirationTime.toUTCString()
    );
}
